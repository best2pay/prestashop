    ...
    {literal}
		...
		$(document).ready(() => {
			...
			$(document).on('click', '.partial-refund-display ,.return-product-display, .standard-refund-display', function(){
				...
				if ($('#best2pay_refund').length === 0) {
					/* Display message if transaction is not captured */
					let refund_checkbox = `<p id="best2pay_refund" class="checkbox" style="color:red">` + non_refundable + `</p>`;
							...
							<div class="cancel-product-element form-group" style="display: block;">
								<div class="checkbox">
									<div class="md-checkbox md-checkbox-inline">
										<label>
											<input type="checkbox" id="best2pay_refund" name="best2pay_refund" checked value="1">
					...
					initLinkedCheckboxes("#cancel_product_credit_slip","#best2pay_refund");
				}
			});
